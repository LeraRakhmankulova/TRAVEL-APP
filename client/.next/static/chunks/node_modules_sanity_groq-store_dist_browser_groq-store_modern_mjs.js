...
eval(__webpack_require__.ts("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"groq\": function() { return /* reexport default export from named module */ groq__WEBPACK_IMPORTED_MODULE_0__; },\n/* harmony export */   \"groqStore\": function() { return /* binding */ w; }\n/* harmony export */ });\n/* harmony import */ var groq__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! groq */ \"./node_modules/groq/lib/groq.js\");\n/* harmony import */ var fast_deep_equal__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! fast-deep-equal */ \"./node_modules/fast-deep-equal/index.js\");\n/* harmony import */ var throttle_debounce__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! throttle-debounce */ \"./node_modules/throttle-debounce/esm/index.js\");\n/* harmony import */ var groq_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! groq-js */ \"./node_modules/groq-js/dist/1.esm.mjs\");\n/* harmony import */ var mendoza__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! mendoza */ \"./node_modules/mendoza/lib/esm/index.js\");\nfunction s(){return s=Object.assign?Object.assign.bind():function(e){for(var t=1;t<arguments.length;t++){var r=arguments[t];for(var n in r)Object.prototype.hasOwnProperty.call(r,n)&&(e[n]=r[n])}return e},s.apply(this,arguments)}const a=(e,t,r)=>{(e=>\"undefined\"!=typeof window&&e.addEventListener===window.EventSource.prototype.addEventListener)(e)&&e.addEventListener(t,r,!1),e.addEventListener(t,r)};function c(e,t,r){const{projectId:n,dataset:o,token:i}=t,s=new e(`https://${n}.api.sanity.io/v1/data/listen/${o}?query=*&effectFormat=mendoza`,{withCredentials:!0,headers:i?{Authorization:`Bearer ${i}`}:void 0});var c;return a(s,\"welcome\",r.open),a(s,\"mutation\",(c=r.next,e=>{let t;try{t=JSON.parse(e.data)}catch(e){return}c(t)})),a(s,\"channelError\",e=>{let t;s.close();try{t=JSON.parse(e.data)}catch(e){return void r.error(new Error(\"Unknown error parsing listener message\"))}r.error(new Error(t.message||t.error||`Listener returned HTTP ${t.statusCode}`))}),a(s,\"error\",e=>{const t=\"undefined\"!=typeof window&&window.location.origin,n=t?`, and that the CORS-origin (${t}) is allowed`:\"\",o=function(e){return\"object\"==typeof e&&null!==e&&\"message\"in e}(e)?` (${e.message})`:\"\";r.error(new Error(`Error establishing listener - check that the project ID and dataset are correct${n}${o}`))}),{unsubscribe:()=>Promise.resolve(s.close())}}function u(e){return e._id.startsWith(\"drafts.\")?e._id.slice(7):e._id}function d(e,t){const r=s({},e);return delete r._rev,(0,mendoza__WEBPACK_IMPORTED_MODULE_4__.applyPatch)(r,t)}function l(){return Promise.resolve()}let f,p=e=>e;const m=async function({projectId:e,dataset:t,token:r,documentLimit:n}){const o=`https://${e}.api.sanity.io/v1/data/export/${t}`,i=r?{Authorization:`Bearer ${r}`}:void 0,s=await fetch(o,{credentials:\"include\",headers:i});if(200!==s.status)throw new Error(`Error streaming dataset: ${a=await s.json(),\"object\"==typeof a&&\"error\"in a&&\"message\"in a?a.message||a.error:\"<unknown error>\"}`);var a;const c=function(e){if(!e)throw new Error(\"Failed to read body from response\");let t,r=!1;function n(){r=!0,t&&t.cancel()}return new ReadableStream({start(o){t=e.getReader();const i=new TextDecoder;let s=\"\";t.read().then(async function e(a){if(a.done){if(r)return;return s=s.trim(),0===s.length||o.enqueue(JSON.parse(s)),void o.close()}s+=i.decode(a.value,{stream:!0});const c=s.split(\"\\n\");for(let e=0;e<c.length-1;++e){const t=c[e].trim();if(0!==t.length)try{o.enqueue(JSON.parse(t))}catch(e){return o.error(e),void n()}}if(s=c[c.length-1],t)try{e(await t.read())}catch(e){o.error(e)}}).catch(e=>o.error(e))},cancel:n})}(s.body),u=c.getReader(),d=[];let l,f;do{if(l=await u.read(),f=l.value,h(f))throw new Error(`Error streaming dataset: ${f.error}`);if(f&&!f._id.startsWith(\"_.\")&&d.push(f),n&&d.length>n)throw u.cancel(\"Reached document limit\"),new Error(`Error streaming dataset: Reached limit of ${n} documents`)}while(!l.done);return d};function h(e){return!!e&&\"error\"in e&&\"object\"==typeof e.error&&null!==e.error&&\"description\"in e.error&&\"string\"==typeof e.error.description&&!(\"_id\"in e)}function w(i){var a;!function(){const e=[\"EventSource\",\"ReadableStream\",\"fetch\"].filter(e=>!(e in window));if(e.length>0)throw new Error(`Browser not supported. Missing browser APIs: ${e.join(\", \")}`)}();const h=null!=(a=i.EventSource)?a:window.EventSource;if(i.token&&h===window.EventSource)throw new Error(\"When`token` option is used, `EventSource` option must also be provided. EventSource cannot be `window.EventSource`, as it does not support passing a token.\");return function(i,a){let m=[];const h=(0,throttle_debounce__WEBPACK_IMPORTED_MODULE_2__.throttle)(i.subscriptionThrottleMs||50,function(){w.forEach(E)}),w=[];let v;async function g(){v||(v=function(e,t,{getDocuments:r,EventSource:n}){const{projectId:o,dataset:i,listen:a,overlayDrafts:f,documentLimit:p,token:m}=e;if(!a)return{unsubscribe:l,loaded:r({projectId:o,dataset:i,documentLimit:p,token:m}).then(j).then(l)};const h=new Map;let w;const v=[];let g,b;const E=new Promise((e,t)=>{g=e,b=t});let y,$,S;return{unsubscribe:c(n,e,{next:function(e){w?(function(e){if(!e.effects||e.documentId.startsWith(\"_.\"))return;const t=h.get(e.documentId)||null;!function(e,t){const r=h.get(e),n=w||[],o=r?n.indexOf(r):-1;-1===o&&t?(n.push(t),h.set(e,t)):t?(n.splice(o,1,t),h.set(e,t)):(n.splice(o,1),h.delete(e))}(e.documentId,d(t,e.effects.apply))}(e),function(e,t){clearTimeout(S),$!==t.transactionId&&y?(j(y),$=void 0):($=t.transactionId,y=e.slice()),S=setTimeout(j,25,e.slice())}(w,e)):v.push(e)},open:async function(){const e=await r({projectId:o,dataset:i,documentLimit:p,token:m});w=function(e,t){const r=new Map;return t.forEach(e=>{const t=r.get(e.documentId)||[];t.push(e),r.set(e.documentId,t)}),r.forEach((t,r)=>{const n=e.find(e=>e._id===r);if(!n)return void console.warn(\"Received mutation for missing document %s\",r);let o=!1,i=n;t.forEach(e=>{o=o||e.previousRev===n._rev,o&&e.effects&&(i=d(i,e.effects.apply))}),e.splice(e.indexOf(n),1,i)}),e}(e,v),w.forEach(e=>h.set(e._id,e)),j(w),g()},error:e=>b(e)}).unsubscribe,loaded:E};function j(e){y=void 0,S=void 0,$=void 0,t(f?function(e){const t=new Map;return e.forEach(e=>{const r=t.get(u(e));e._id.startsWith(\"drafts.\")?t.set(u(e),function(e){return s({},e,{_id:u(e)})}(e)):r||t.set(e._id,e)}),Array.from(t.values())}(e):e)}}(i,e=>{m=e,h()},a)),await v.loaded}async function b(e,t){await g();const r=(0,groq_js__WEBPACK_IMPORTED_MODULE_3__.parse)(e,{params:t});return(await (0,groq_js__WEBPACK_IMPORTED_MODULE_3__.evaluate)(r,{dataset:m,params:t})).get()}function E(e){return b(e.query,e.params).then(r=>{\"previousResult\"in e&&fast_deep_equal__WEBPACK_IMPORTED_MODULE_1__(e.previousResult,r)||(e.previousResult=r,e.callback(void 0,r))}).catch(t=>{e.callback(t)})}return{query:b,getDocument:async function(t){return await g(),b(groq__WEBPACK_IMPORTED_MODULE_0__(f||(f=p`*[_id == $id][0]`)),{id:t})},getDocuments:async function(e){return await g(),b(`[${e.map(e=>`*[_id == \"${e}\"][0]`).join(\",\\n\")}]`)},subscribe:function(e,t,r){if(!i.listen)throw new Error(\"Cannot use `subscribe()` without `listen: true`\");const n={query:e,params:t,callback:r};w.push(n);let o=!1;return E(n),{unsubscribe:()=>(o||(o=!0,w.splice(w.indexOf(n),1)),Promise.resolve())}},close:function(){return h.cancel(),v?v.unsubscribe():Promise.resolve()}}}(i,{EventSource:h,getDocuments:m})}\n//# sourceMappingURL=groq-store.modern.mjs.map\n//# sourceURL=[module]\n//# sourceMappingURL=data:application/json;charset=utf-8;base64,\n//# sourceURL=webpack-internal:///./node_modules/@sanity/groq-store/dist/browser/groq-store.modern.mjs\n"));
