...
function useTap(isStatic, { whileTap, onTapStart, onTap, onTapCancel, onPointerDown, }, visualElement) {
    ...
    return {
        onPointerDown: framerMotion.wrapHandler((event, info) => {
            ...
            cancelPointerEndListeners.current = popmotion.pipe(framerMotion.addPointerEvent(window, "pointerup", onPointerUp, options), framerMotion.addPointerEvent(window, "pointercancel", onPointerCancel, options));
